    ...
    public function new(daStage:String)
    {
        ...
        switch(daStage)
        {
			...
			case 'jokeplains': 
			{
				...
				var hallowTex = Paths.getSparrowAtlas('jokesourbg','week1');

				var halloweenBG = new FlxSprite(-225, 50);
				halloweenBG.frames = hallowTex;
			...
			case 'factory-classic': 
			{
				...
				var hallowTex = Paths.getSparrowAtlas('sourbg','week1');

				var halloweenBG = new FlxSprite(-285, 50);
				halloweenBG.frames = hallowTex;
				halloweenBG.animation.addByPrefix('idle', 'halloweem bg', 20, true);
				halloweenBG.animation.play('idle');
				halloweenBG.antialiasing = true;
			...
			case 'factory': 
			{
				...
				var hallowTex = Paths.getSparrowAtlas('newsourbg','week1');

				var halloweenBG = new FlxSprite(-585, 50);
				halloweenBG.frames = hallowTex;
				halloweenBG.animation.addByPrefix('idle', 'halloweem bg', 20, true);
				halloweenBG.animation.play('idle');
				halloweenBG.antialiasing = true;
